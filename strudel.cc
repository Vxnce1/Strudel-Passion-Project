...
// =========================================================================
// MAIN PLAYBACK CONTROL (ARRANGE BLOCK)
// =========================================================================


//4 = 1 bar/16 beats
$: arrange(
  [4*6, stack(pchords, verse)],
  [4, stack(cat(dr1, dr1, dr2, dr2))],
  [4*2, stack(chordP1, fulldr1, m1, bassline)],
  [4*2, stack(fulldr1.gain(0.6), cat(note(chords5), note(chords6)).slow(4).sound("piano"), cat(note(line5), note(line6)).slow(4).sound("piano"))]
)
